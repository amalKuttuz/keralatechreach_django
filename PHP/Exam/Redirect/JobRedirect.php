...
$app_link = "intent://www.keralatechreach.in/Exam/Redirect/JobRedirect.php?job_title=" . urlencode($job_title) . 
            "&company_name=" . urlencode($company_name) . 
            "&job_id=" . urlencode($job_id) . 
            "#Intent;scheme=https;package=" . $package_name . ";end";

// Fallback web URL
$web_url = "https://www.keralatechreach.in/Exam/Redirect/JobRedirect.php?job_title=" . urlencode($job_title) . 
          "&company_name=" . urlencode($company_name) . 
          "&job_id=" . urlencode($job_id);
