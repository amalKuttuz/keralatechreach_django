...
$app_link = "intent://www.keralatechreach.in/Exam/Redirect/questions.php?university_name=" . urlencode($university_name) . 
...
// Fallback web URL
$web_url = "https://www.keralatechreach.in/Exam/Redirect/questions.php?university_name=" . urlencode($university_name) . 
          "&university_id=" . urlencode($university_id) . 
          "&deg=" . urlencode($deg) . 
          "&subj=" . urlencode($subj);
...
<html>
<head>
    <title>KStudents Question Papers</title>
...
<body>
    <div class="container">
        <h1>KStudents Question Papers</h1>
        <p>View question papers for <?php echo htmlspecialchars($university_name); ?>, <?php echo htmlspecialchars($deg); ?>, Semester <?php echo htmlspecialchars($subj); ?></p>
