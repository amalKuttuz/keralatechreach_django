...
$app_link = "intent://www.keralatechreach.in/EventRedirect.php?event_name=" . urlencode($event_name) . 
...
// Fallback web URL
$web_url = "https://www.keralatechreach.in/EventRedirect.php?event_name=" . urlencode($event_name) . 
           "&event_id=" . urlencode($event_id);
