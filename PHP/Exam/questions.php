...
$app_link = "intent://www.keralatechreach.in/Exam/questions.php?university_name=" . urlencode($university_name) . 
...
// Fallback web URL
$web_url = "https://www.keralatechreach.in/Exam/questions.php?university_name=" . urlencode($university_name) . 
          "&university_id=" . urlencode($university_id) . 
          "&deg=" . urlencode($deg) . 
          "&subj=" . urlencode($subj);
